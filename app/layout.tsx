...
export const metadata: Metadata = {
  title: "checkNews — 뉴스 편향 분석",
  description: "한국어 뉴스의 편향 어투를 분석하여 객관적인 정보 소비를 돕습니다.",
};
    ...
    <aside className="fixed left-0 top-0 h-full w-56 bg-white border-r border-gray-200 flex flex-col z-20">
      <div className="px-5 py-5 border-b border-gray-100">
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="font-bold text-gray-900 text-base">checkNews</span>
        </Link>
      </div>
      ...
      <nav className="flex-1 px-3 py-4 space-y-1">
        {navItems.map((item) => (
          <Link
            key={item.href}
            href={item.href}
            className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-gray-600 hover:bg-gray-50 hover:text-gray-900 transition-colors text-sm font-medium group"
          >
